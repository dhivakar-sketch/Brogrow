...
export default function PerformanceIntelligence({ assessments = [], insights = [], athleteName = 'Athlete' }) {
  ...
  if (!latest) return <div className="panel"><div className="panel-header"><h2>◈ Performance Intelligence</h2></div><div className="empty-state"><div className="empty-icon">📊</div><p>Complete an assessment to unlock athlete-specific performance intelligence.</p></div><AssessmentHistory assessments={assessments} athleteName={athleteName} /></div>

  return <>
    <div className="panel performance-intelligence">
